      ...
      try {
        ...
        if (s.v2gSimulationCommitted && typeof s.v2gSimulationCommitted === 'object') {
          ...
          setV2gSimulationInputs({
            ...
            socLowerPct: v.socLowerPct ?? '',
            socUpperPct: v.socUpperPct ?? '',
            returnSocPct: v.returnSocPct ?? '',
            targetSocPct: v.targetSocPct ?? '',
            chargingEfficiencyPct: v.chargingEfficiencyPct ?? '',
            dischargingEfficiencyPct: v.dischargingEfficiencyPct ?? '',
